export const SRD_ITEMS = [
  ...
  // ── Magic Items ───────────────────────────────────────────────────────────
  {id:25, name:"+1 Waffe",          type:"Weapon",sub:"Magic",          dmg:"+1",ac:"",eff:"",wt:"—",   rar:"Uncommon",notes:"+1 auf Angriff und Schaden. Gilt als magisch."},
  {id:26, name:"+2 Waffe",          type:"Weapon",sub:"Magic",          dmg:"+2",ac:"",eff:"",wt:"—",   rar:"Rare",    notes:"+2 auf Angriff und Schaden."},
  {id:27, name:"+3 Waffe",          type:"Weapon",sub:"Magic",          dmg:"+3",ac:"",eff:"",wt:"—",   rar:"Very Rare",notes:"+3 auf Angriff und Schaden."},
  {id:28, name:"+1 Rüstung",        type:"Armor", sub:"Magic",          dmg:"",ac:"+1",eff:"",wt:"—",   rar:"Rare",    notes:"+1 auf AC-Basiswert."},
  {id:29, name:"Amulett der Gesundheit",type:"Item",sub:"Magic",        dmg:"",ac:"",eff:"CON=19",wt:"—",rar:"Rare",    notes:"Req. Attunement. CON wird 19."},
  {id:30, name:"Ring der Unsichtbarkeit",type:"Item",sub:"Magic",       dmg:"",ac:"",eff:"Unsichtbar",wt:"—",rar:"Legendary",notes:"Req. Attunement. Unsichtbar bis Angriff/Zauber."},
  {id:31, name:"Stiefel des Elfenschritts",type:"Item",sub:"Magic",     dmg:"",ac:"",eff:"Kein Stealth-Nachteil",wt:"—",rar:"Uncommon",notes:"Req. Attunement. Bewegungsgeräusche unterdrückt."},
  {id:32, name:"Umhang des Schutzes",type:"Item", sub:"Magic",          dmg:"",ac:"+1",eff:"+1 Saves",wt:"—",rar:"Uncommon",notes:"Req. Attunement. +1 AC und alle Rettungswürfe."},
  {id:33, name:"Handschuhe der Stärke",type:"Item",sub:"Magic",         dmg:"",ac:"",eff:"STR=19",wt:"—",rar:"Rare",    notes:"Req. Attunement. STR wird 19."},
  {id:34, name:"Mithral-Rüstung",   type:"Armor", sub:"Magic",          dmg:"",ac:"Normal",eff:"",wt:"—",rar:"Uncommon",notes:"Kein STR-Req. Kein Stealth-Nachteil."},
  {id:35, name:"Vorpal-Schwert",    type:"Weapon",sub:"Magic",          dmg:"+3",ac:"",eff:"Nat20=Enthauptung",wt:"—",rar:"Legendary",notes:"Req. Attunement. Nat20 ohne Kopf-Immunität: Enthauptung."},
  {id:36, name:"Froststahl",        type:"Weapon",sub:"Magic",          dmg:"+1d6 K",ac:"",eff:"Feuer-Resist",wt:"3 lb",rar:"Very Rare",notes:"Req. Attunement. +1d6 Kälteschaden. Feuerresistenz."},
  {id:37, name:"Tarnumhang",        type:"Item",  sub:"Magic",          dmg:"",ac:"",eff:"+10 Stealth",wt:"—",rar:"Uncommon",notes:"+10 auf Stealth. Aktion: vollständig unsichtbar."},
  {id:107,name:"Beutel der Überkapazität",type:"Item",sub:"Magic",      dmg:"",ac:"",eff:"64 cbft Raum",wt:"15 lb",rar:"Uncommon",notes:"Extradimensionaler Raum: 64 Kubikfuß / 500 Pfund."},
  {id:108,name:"Schutzring",        type:"Item",  sub:"Magic",          dmg:"",ac:"+1",eff:"+1 Saves",wt:"—",rar:"Uncommon",notes:"Req. Attunement. +1 AC und Rettungswürfe."},
  {id:109,name:"Stirnband des Intellekts",type:"Item",sub:"Magic",      dmg:"",ac:"",eff:"INT=19",wt:"—",rar:"Uncommon",notes:"Req. Attunement. INT wird 19."},
  {id:110,name:"Schuhe der Schnelligkeit",type:"Item",sub:"Magic",      dmg:"",ac:"",eff:"Speed ×2",wt:"—",rar:"Very Rare",notes:"Req. Attunement. Bewegungsrate verdoppelt. Dash Bonus-Aktion."},
  {id:111,name:"Halsband der Feuerbälle",type:"Item",sub:"Magic",       dmg:"",ac:"",eff:"Feuerbälle",wt:"1 lb",rar:"Rare",notes:"1–7 Perlen. Jede: Feuerball DC 15, 10d6 Schaden."},
  {id:112,name:"Perle der Macht",   type:"Item",  sub:"Magic",          dmg:"",ac:"",eff:"Slot zurück",wt:"—",rar:"Uncommon",notes:"Req. Attunement (Zauberer). Slot 3. Grades oder niedriger zurück."},
  {id:113,name:"Flammenzunge",      type:"Weapon",sub:"Magic",          dmg:"+2d6 F",ac:"",eff:"Licht 40ft",wt:"3 lb",rar:"Rare",notes:"Req. Attunement. Befehlswort: Klinge entzündet sich. 2d6 Feuer."},
  {id:114,name:"Handschuhe der Ogrenkraft",type:"Item",sub:"Magic",     dmg:"",ac:"",eff:"STR=19",wt:"—",rar:"Uncommon",notes:"Req. Attunement. STR wird 19 (wenn nicht höher)."},
  {id:115,name:"Mantel der Verschiebung",type:"Item",sub:"Magic",       dmg:"",ac:"",eff:"Nachteil auf Angriffe",wt:"—",rar:"Rare",notes:"Req. Attunement. Angriffe auf dich haben Nachteil (bis getroffen)."},
];
